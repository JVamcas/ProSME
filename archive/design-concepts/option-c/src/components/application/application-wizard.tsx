  ...
  return <form onSubmit={handleSubmit(submit)} className="card overflow-hidden">
    ...
    <div className="p-6 sm:p-9">
      ...
      {step === 4 && <div className="grid gap-6">
        ...
        <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-slate-200 p-5"><input type="checkbox" className="mt-1 size-4 accent-[#082a4a]" {...register("declaration")} /><span className="text-sm leading-6 text-slate-600"><strong className="block text-navy">Applicant declaration</strong>I confirm that the information provided is true, accurate and complete, and understand that misleading information may result in disqualification.</span></label><FieldError message={errors.declaration?.message}/>
        <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-slate-200 p-5"><input type="checkbox" className="mt-1 size-4 accent-[#082a4a]" {...register("consent")} /><span className="text-sm leading-6 text-slate-600"><strong className="block text-navy">Consent to verification</strong>I consent to verification of the information and supporting documentation and agree to the applicable programme terms.</span></label><FieldError message={errors.consent?.message}/>
      </div>}
    </div>
