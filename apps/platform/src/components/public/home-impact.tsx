  ...
  return (
    <section className="bg-navy py-14 text-white">
      <div className="container">
        <h2 className="text-3xl font-bold">Real businesses, lasting impact.</h2>
        <p className="mt-2 text-white/70">
          Together, we’re building a more competitive Namibia that supports MSME
          growth.
        </p>
        <div className="mt-8 grid grid-cols-2 gap-5 lg:grid-cols-4">
          {statistics.map(({ value, label }) => (
            ...
            >
              ...
              <span className="mt-1 block text-sm text-white/65">{label}</span>
            </div>
          ))}
        </div>
      </div>
