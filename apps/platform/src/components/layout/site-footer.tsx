    ...
    <footer className="bg-brand-orange text-brand-navy">
      <div className="container grid gap-9 py-12 md:grid-cols-[1.1fr_.7fr_.8fr_1.25fr]">
        <div>
          ...
          />
          <p className="mt-4 max-w-xs text-sm font-bold">
            {content.tagline}
          </p>
        ...
        <div>
          ...
          <p className="mt-3 max-w-xs text-sm leading-5">
            {content.newsletterSummary}
          </p>
          <NewsletterForm />
        </div>
      </div>

      <div className="container flex flex-col gap-2 border-t border-brand-navy/25 py-5 text-xs sm:flex-row sm:justify-between">
