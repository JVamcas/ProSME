    ...
    <div className="mt-6 grid gap-5 lg:grid-cols-2">
      ...
      <section className="card p-6">
        ...
        <button className="mt-4 flex w-full items-center gap-3 rounded-2xl bg-amber-50 p-4 text-left">
          <span className="grid size-9 place-items-center rounded-full bg-white"><Bell className="size-4 text-amber-700" /></span>
          <span className="flex-1 text-xs leading-5 text-slate-600"><strong className="block text-navy">Application received</strong>Your reference is {reference}</span>
