...
export function ConfirmationView() {
  ...
  return (
    <div className="card overflow-hidden text-center">
      <div className="bg-emerald-50 px-6 py-12">
        <div className="mx-auto grid size-20 place-items-center rounded-full bg-emerald-600 text-white shadow-lg shadow-emerald-200">
          <CheckCircle2 className="size-10" />
        </div>
        <p className="eyebrow mt-7 text-emerald-700">Application received</p>
        <h1 className="display mt-3 text-4xl font-semibold text-navy sm:text-5xl">
          Thank you{application.firstName ? `, ${application.firstName}` : ""}.
        </h1>
        <p className="mx-auto mt-4 max-w-xl leading-7 text-slate-600">
          Your application has entered the completeness-check stage. Keep your
      ...
      <div className="p-7 sm:p-10">
        <div className="mx-auto max-w-md rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-6">
          ...
          <div className="mt-2 flex items-center justify-center gap-3">
            <strong className="text-2xl tracking-wide text-navy">
              {displayReference}
            </strong>
            <IconButton
              label="Copy application reference"
              type="button"
              variant="ghost"
              onClick={() => {
              ...
              className="size-8 text-slate-400 hover:text-navy"
            >
        ...
        <div className="mx-auto mt-8 grid max-w-2xl gap-4 text-left sm:grid-cols-2">
          <div className="flex gap-3 rounded-2xl bg-orange-pale p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-slate-600">
                The programme team checks whether the application and supporting
          ...
          <div className="flex gap-3 rounded-2xl bg-amber-50 p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-slate-600">
                Any request for additional information will appear on your
                dashboard.
              </p>
            </div>
          </div>
