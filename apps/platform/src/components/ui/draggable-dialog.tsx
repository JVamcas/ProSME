...
function DraggableDialogPanel({
  ...
  const dialog = (
    <div
      className="fixed inset-0 z-[100] flex items-end justify-center overflow-y-auto bg-brand-navy/20 p-2 sm:items-center sm:p-5"
      onMouseDown={(event) => {
    ...
    >
      ...
      >
        <header
          className="flex cursor-grab touch-none select-none items-center justify-between border-b border-brand-navy/10 px-5 py-4 active:cursor-grabbing sm:px-6"
        ...
        >
          ...
          <button
            ...
            className="grid size-9 place-items-center rounded-full text-brand-navy/55 transition hover:bg-brand-cream hover:text-brand-navy"
            onClick={onClose}
            ref={closeRef}
            type="button"
          >
