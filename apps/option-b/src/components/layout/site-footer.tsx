...
export function SiteFooter() {
  return (
    <footer className="bg-navy text-white">
      ...
      <div className="border-t border-white/10"><div className="container flex flex-col gap-2 py-5 text-xs text-white/45 sm:flex-row sm:justify-between"><p>© 2026 ProSME. Prototype for demonstration.</p><p>Implemented by NIPDB in partnership with NPC, supported by GIZ.</p></div></div>
    </footer>
  );
}
