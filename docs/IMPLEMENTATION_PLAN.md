...
| Applicant portal implementation | In progress | P3.2 funding opportunities, eligibility, and application sections are implemented; independent review remains pending |
...
| P3.4 Documents, declarations and submission | Private storage adapter, document metadata and scan states, declarations, review, idempotent submission/reference, and transactional creation of the initial workflow instance from the opportunity's assigned published workflow version | Applicant screens 10–13 | `docs/testing/gates/P3.4-documents-submission.md` | In progress — implementation complete; independent review pending | Transaction, assignment/version-pinning, duplicate-submit, access, declaration, and upload tests |
| P3.5 Work queue, applications, screening and information requests | Task and submitted-application projections, assignment/claim, completeness and document-review tasks, and the information request/response loop | Admin screens 2–9; Applicant screen 14 | `docs/testing/gates/P3.5-work-queue-screening.md` | In progress — work queue, application list, atomic role-task claim, and configurable pre-screening checklist implemented | Queue query plan, capability and assignment tests, screening transitions, and end-to-end request loop |
...
| P3.8 Users, access, reports, audit and bulk operations | Admin dashboard, user/role/capability management, reports, audited CSV/Excel export, bulk status and communication enhancements to Applications, audit log, and remaining workflow-administration operations | Admin screen 1, enhancements to screen 3, and screens 15–20 | `docs/testing/gates/P3.8-administration-reporting.md` | In progress — Admin screen 1 implemented | Dashboard reconciliation, permission matrix, export projection, audit, reporting, and bulk transaction tests |
